...
public class SamiaSceneSwitch {
    public static void samiaSceneSwitch(Node sourceNode, String branchPath, String fxmlFileName, String title) throws IOException{
        FXMLLoader loader = new FXMLLoader(SamiaSceneSwitch.class.getResource("/com/example/group52_cse213finalproject_2310604_2022752_2110304_2431072_summitpower/samia/" + branchPath + "/" + fxmlFileName));
