...
public class FinancialSummaryFileHandler {
    private static final String FILE_PATH = "data/rubama/ceo/financialSummary.bin";
    public static void save(FinancialSummary financialSummary) {
        ObservableList<FinancialSummary> list = readAll();
    ...
    public static ObservableList<FinancialSummary> readAll() {
        ...
        try{
            ...
            ArrayList<FinancialSummary> list = (ArrayList<FinancialSummary>) ois.readObject();
            ois.close();
