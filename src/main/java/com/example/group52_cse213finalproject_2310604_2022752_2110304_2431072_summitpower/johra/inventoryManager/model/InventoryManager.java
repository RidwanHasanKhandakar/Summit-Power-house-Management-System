...
public class InventoryManager extends User implements Serializable {
    ...
    public InventoryManager(String firstName, String lastName, String address, String phoneNumber, String gender, LocalDate dateOfBirth, String userId, String email, String password, String role) {
