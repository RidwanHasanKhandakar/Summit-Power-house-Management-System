...
public class FuelConsumptionFileHandler {

    private static final String FILE_PATH = "data/johra/inventoryManager/fuelConsumption.bin";
    public static void save(FuelConsumption fuelConsumption) {
        ObservableList<FuelConsumption> list = readAll();
    ...
    public static ObservableList<FuelConsumption> readAll() {
        ...
        try{
            ...
            ArrayList<FuelConsumption> list = (ArrayList<FuelConsumption>) ois.readObject();
            ois.close();
